...
class Config {
  ...
  init(env) {
    this.env = env;
    this.bitmex = {
      ApiKey: this.env === CONST.ENV.TEST ? KEYS.bitmex.ApiKeyTest : KEYS.bitmex.ApiKey,
      ApiSecret: this.env === CONST.ENV.TEST ? KEYS.bitmex.ApiSecretTest : KEYS.bitmex.ApiSecret
    };
    this.bitflyer = {
