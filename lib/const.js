...
// 基本設定値
exports.MAX_RETRY_CNT = 1;
exports.WHOLE_LOT_RATE = 0.9;
exports.BASIC_STOP_LOSS_PERCENTAGE = 8;
exports.MIN_ADD_QTY_BF = 0.01;
exports.MIN_ADD_QTY_MEX = 10;

exports.REPLACE_EXCHANGE = '%%%REPLACE_EXCHANGE%%%';
exports.REPLACE_SYMBOL = '%%%REPLACE_SYMBOL%%%';
exports.URL_CRYPTOWATCH = 'https://api.cryptowat.ch/markets/'+exports.REPLACE_EXCHANGE+'/'+exports.REPLACE_SYMBOL;
...
exports.CRYPTOWATCH_BTC_FX_JPY = 'btcfxjpy';

exports.STR_ADMIN = ['ADMIN'];
exports.EXCHANGE_BITFLYER = ['BF'];

exports.STR_LEVERAGE_ARRAY = ['LV','LEV','LEVERAGE'];
exports.STR_BUY_SIDE_ARRAY = ['BUY','LONG','TFLONG','CONTLONG'];
exports.STR_SELL_SIDE_ARRAY = ['SELL','SHORT','TFSHORT','CONTSHORT','ESHORT'];
exports.STR_CLOSE_ARRAY = ['CLOSE','EXIT'];
exports.STR_INFO_ARRAY = ['INFO','POSITION','POS','BALANCE'];
exports.STR_MODE_ON_ARRAY = ['MON','ACTIVATE','START'];
exports.STR_MODE_OFF_ARRAY = ['MOFF','DEACTIVATE','STOP'];
// exports.STR_MODE = 'MODE';
exports.STR_REDOTEN_ARRAY = ['REDOTEN','RD'];
exports.STR_STOPLOSS_ARRAY = ['STOPLOSS','SL'];
...
exports.MSG_GET_CLOSED_ODERS = 'クローズドOrder取得';
exports.MSG_CANCEL_ORDER = 'Orderキャンセル';
exports.MSG_ORDER_CHECK = 'Order取得';
