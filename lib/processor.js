...
function getSymbolPairCryptowatch(symbolStr, exchange) {
  // 売買指示用通貨ペアセット
  let symbolPair = null;
  if (CONST.EXCHANGE.BITFLYER === exchange) {
    symbolPair = CONST.CRYPTOWATCH_BTC_FX_JPY;
  } else if (CONST.EXCHANGE.BITMEX === exchange) {
    symbolPair = 'btcusd-perpetual-futures';
  }
  return symbolPair;
}
...
module.exports.getSymbolPairCryptowatch = getSymbolPairCryptowatch
